...
import { FaGithub, FaLinkedin, FaLink } from "react-icons/fa6";

export default function Footer() {
    return (
        <footer className="dark:bg-black py-50 px-35">
            ...
            <div className="flex flex-col md:flex-row gap-10 justify-between items-center">
                <div className="max-w-4xl">
                    <p className="font-sans font-stretch-expanded pb-10 text-orange-400 uppercase">Ready To Build?</p>
                ...
                <div className="flex flex-col ml-auto mt-25 gap-3 pr-30">
                    <div className="">
                        <Link
                            href="mailto:jtanner0786@gmail.com"
                            className="flex items-center text-center bg-white border rounded-full pr-4 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                            <span className="font-serif text-black uppercase font-bold pl-5 pt-5 pb-5">Start a project</span>
                            <div className="dark:bg-black border rounded-full ml-2 mr-2">
                                <FaLink color="white" className="size-10 p-2" />
                            </div>
                        </Link>
                    </div>
            ...
            <div className="flex flex-col md:flex-row gap-20">
                <div className="max-w-20">
                    <p className="font-serif">
                        <span className="italic text-white/50 text-xs">Location </span> 
                        USA, EST
                    </p>
                </div>
                <div className="max-w-20">
                    <p className="font-serif">
                        <span className="italic text-white/50 text-xs">Local Time </span> 
                        USA, EST
                    </p>
                </div>
